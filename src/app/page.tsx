            ...
            >
              ...
              {validMode === 'about' && (
                <p className="text-gray-500 text-base md:text-lg max-w-xl mx-auto">
                  ...
                  <br />
                  building <a href="https://usesubspace.live" target="_blank" rel="noopener noreferrer" className="text-foreground underline decoration-2 underline-offset-2 decoration-muted-foreground">subspace</a> — an ai productivity platform for students.
                </p>
              )}
              {validMode === 'work' && (
