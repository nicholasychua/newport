...
function ModeHandler() {
  ...
  return (
    <div className="min-h-screen bg-background relative flex flex-col">
        ...
        right={
          <Button
            ...
            style={{
              marginRight: 0,
              boxShadow:
                "0 4px 24px 0 rgba(0,0,0,0.10), 0 0 0 1px rgba(0,0,0,0.02)",
            }}
          >
            <svg
              width="36"
            ...
            >
              ...
              />
              <path
                d="M10 36c0-6.5 8-8 12-8s12 1.5 12 8"
                stroke="#A3A3A3"
                strokeWidth="2.5"
                fill="none"
                strokeLinecap="round"
      ...
      <main
        ref={mainRef}
        className="container mx-auto px-4 pt-28 md:pt-36 pb-24 flex-grow flex flex-col overflow-y-auto"
      >
        {/* Full-width background gradient and blobs */}
        <div
          aria-hidden="true"
          className="absolute top-0 left-0 w-full h-[480px] md:h-[560px] z-0 pointer-events-none"
        >
          {/* Soft gradient */}
            ...
            >
              ...
              {validMode === "about" && (
                <p className="text-gray-500 text-base md:text-lg max-w-xl mx-auto">
                  ...
                  <br />
                  building the creative layer between product and distribution
                </p>
              )}
              {validMode === "work" && (
                <p className="text-gray-500 text-base md:text-lg max-w-md mx-auto">
                  working with startups and unicorns to build products that
                  users will love.
                </p>
              )}
              {validMode === "writing" && (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  Filter by tags
                  <ChevronDown
                    className={`h-3.5 w-3.5 text-gray-500 transition-transform ${isTagsMenuOpen ? "rotate-180" : ""}`}
                  />
                </Button>
                  ...
                  <div className="max-h-[300px] overflow-y-auto">
                    <div className="flex flex-col gap-1 py-1">
                      {allTags.map((tag) => (
                        ...
                        >
                          <div
                            className={`w-4 h-4 rounded border ${selectedTags.includes(tag) ? "bg-primary border-primary" : "border-gray-300"} flex items-center justify-center`}
                          >
        ...
        <>
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-600 mt-2">
              Selected projects on product design and growth strategies
            </p>
          </div>
