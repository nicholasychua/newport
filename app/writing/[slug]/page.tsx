...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      // Check if the clicked element is a link to the writing page or has a parent link to writing
      const target = e.target as HTMLElement;
      const linkElement = target.closest('a[href="/writing"]');
      ...
      if (linkElement) {
        ...
        // Then navigate after animation completes (reduced to 300ms)
        setTimeout(() => {
          router.push('/writing');
        }, 300);
      }
